...
// --- Tiptap UI ---
import type { UseVideoUploadConfig } from "@/components/tiptap-ui/video-upload-button/use-video-upload"
import {
    VIDEO_UPLOAD_SHORTCUT_KEY,
    useVideoUpload,
} from "@/components/tiptap-ui/video-upload-button/use-video-upload"
    ...
    (
        ...
        return (
            <Button
                ...
                aria-label={isUploading ? "Uploading video..." : label}
