...
// Adapted from reactbits.dev "Prism" (ogl). A rotating 3D prism that refracts
// light into a spectrum — used as the IntelliVault hero centerpiece (one beam
// in, an ordered spectrum out, mirroring chaos → structured notes). Client-only:
// touches window/canvas/WebGL.
